...
Nova.booting(function (Vue, router) {
    Vue.component('index-FieldCheckboxes', __webpack_require__(5));
    Vue.component('detail-FieldCheckboxes', __webpack_require__(8));
    Vue.component('form-FieldCheckboxes', __webpack_require__(14));
});
        ...
        _vm.field.withGroups
          ? _c(
              ...
              _vm._l(_vm.field.options, function(permissions, group) {
                return _c(
                  "div",
                  { key: group, staticClass: "mb-4" },
                  [
                    _c("h3", { staticClass: "my-2" }, [
                      _vm._v(_vm._s(_vm.__(group)))
                    ]),
                    _vm._v(" "),
                    _vm._l(permissions, function(permission, option) {
                      return _c(
                        "div",
                        { key: option, staticClass: "flex-auto" },
                        [
                          _c("span", {
                            staticClass:
                          ...
                          _vm._v(" "),
                          _c("span", [_vm._v(_vm._s(permission.label))])
                        ]
                      )
                    })
                  ],
      ...
      _c("template", { slot: "field" }, [
        _c("div", { staticClass: "w-full mb-4" }, [
          ...
          _c(
            "span",
            {
              staticClass: "ml-auto btn btn-default",
              on: {
                click: function($event) {
                  _vm.uncheckAll()
                }
            ...
            [_vm._v(_vm._s(_vm.__("Do not select any")))]
          )
        ]),
        _vm._v(" "),
        _vm.field.withGroups
                ...
                return _c(
                  ...
                  [
                    ...
                    _vm._l(permissions, function(permission, option) {
                      return _c(
                        "div",
                        { key: permission.option, staticClass: "flex mb-2" },
                        [
                          _c("checkbox", {
                            staticClass: "pr-2",
                            attrs: {
                            ...
                            on: {
                              input: function($event) {
                                _vm.toggleOption(permission.option)
                              }
                            }
                          }),
                          _vm._v(" "),
